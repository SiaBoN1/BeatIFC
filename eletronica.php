  ...
  <main id="main">
    ...
    <section id="call-to-action" class="wow fadeIn">
      <div class="container text-center">
        ...
        <button class="cta-btn2">Pop</button>
        <button class="cta-btn2">Rock</button>
        <button class="cta-btn2">Funk</button>
        <button class="cta-btn2">Sernatejo</button>
        <button class="cta-btn2">Indie</button>
        <button class="cta-btn2">K-Pop</button>
        <button class="cta-btn2">Pagode</button>
        <button class="cta-btn2">Eletrônica</button>
        <button class="cta-btn2">Reggae</button>
        <button class="cta-btn2">Hip Hop</button>
        <button class="cta-btn2">Alternative</button>
        <button class="cta-btn2">Classica</button>
        <button class="cta-btn2">Trap</button>
        <button class="cta-btn2">Outro</button>
    ...
    <section id="results">
      ...
      <div class="container text-center">
        ...
        $sql = "SELECT * FROM musica WHERE nome LIKE '%$pesquisa%' OR autor LIKE '%$pesquisa%'";
        $consulta = mysqli_query($conexao, $sql)or die(mysqli_error);
        }
