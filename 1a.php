...
<head>
  <meta charset="utf-8">
  <title>Beat IFC - Primeiro Ano A</title>
...
<body>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="img/turma/1a/1a-2019.jpeg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Primeiro Ano A</h2>
  ...
  <main id="main">
    ...
    <section id="featured-services" class="player">
      <div class="container">
        <div class="row">
          <iframe width="100%" height="0" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/767802066&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>
    ...
    <section id="services">
      <div class="container">
        ...
        <header class="section-header wow fadeInUp">
          <h3>Playlist</h3>
          <p>Conheça a playlist criada pelos calouros do 1°A e saiba quais hits não saem de seus ouvidos.</p>
          <?php
    ...
    <section id="portfolio"  class="section-bg" >
      ...
      <div class="container">
        ...
        <div class="row portfolio-container">
                   ...
                   <?php
                  $buscaMo = "SELECT * FROM momentos WHERE codTurma = '1'";
    ...
    <section id="team">
      <div class="container">
        <div class="section-header wow fadeInUp">
          <h3>Alunos</h3>
          <p>Conheça os integrantes da turma do Primeiro Ano A.</p>
        </div>

        <div class="row">

          <?php
                  $buscaA = "SELECT * FROM usuario WHERE turma = '1' ORDER BY nome ASC";
