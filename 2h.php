...
<head>
  <meta charset="utf-8">
  <title>Beat IFC - Segundo Ano H</title>
...
<body>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="img/turma/2h/2h-2019.jpeg" alt=""></div>
  ...
  <main id="main">
    ...
    <section id="featured-services" class="player">
      <div class="container">
        <div class="row">
          <iframe width="100%" height="0" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/783425745&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>
    ...
    <section id="portfolio"  class="section-bg" >
      ...
      <div class="container">
        ...
        <div class="row portfolio-container">
                   ...
                   <?php
                  $buscaMo = "SELECT * FROM momentos WHERE codTurma = '6'";
    ...
    <section id="team">
      <div class="container">
        <div class="section-header wow fadeInUp">
          <h3>Alunos</h3>
          <p>Conheça os integrantes da turma do Segundo Ano H.</p>
        </div>

        <div class="row">

          <?php
                  $buscaA = "SELECT * FROM usuario WHERE turma = '6' ORDER BY nome ASC";
