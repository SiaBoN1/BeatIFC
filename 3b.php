...
<head>
  <meta charset="utf-8">
  <title>Beat IFC - Terceiro Ano B</title>
...
<body>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="img/turma/3b/3b-2019.jpeg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Terceiro Ano B</h2>
  ...
  <main id="main">
    ...
    <section id="featured-services" class="player">
      <div class="container">
        <div class="row">
         <iframe width="100%" height="0" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/783425889&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>
    ...
    <section id="services">
      <div class="container">
        ...
        <header class="section-header wow fadeInUp">
          <h3>Playlist</h3>
          <p>Conheça a playlist criada pelos veteranos do 3°B e saiba quais hits não saem de seus ouvidos.</p>
          <?php
    ...
    <section id="portfolio"  class="section-bg" >
      ...
      <div class="container">
        ...
        <header class="section-header">
          <h3 class="section-title">Momentos 3B</h3>
          <?php
            $checagem = "SELECT turma FROM usuario WHERE codUsuario =".$_SESSION['usuario'];
            $katiau = mysqli_query($conexao, $checagem)or die(mysqli_error);
            if ($katiau->num_rows > 0){
        ...
        <div class="row portfolio-container">
                   ...
                   <?php
                  $buscaMo = "SELECT * FROM momentos WHERE codTurma = '8'";
    ...
    <section id="team">
      <div class="container">
        <div class="section-header wow fadeInUp">
          <h3>Alunos</h3>
          <p>Conheça os integrantes da turma do Terceiro Ano B.</p>
        </div>

        <div class="row">

          <?php
                  $buscaA = "SELECT * FROM usuario WHERE turma = '8' ORDER BY nome ASC";
