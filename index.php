          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <a href="login.php" class="btn-get-started scrollto">Começar Agora</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            ...
            <h4 class="title"><a href="">Envie sugestões</a></h4>
    ...
    <section id="contact" class="section-bg wow fadeInUp">
      <div class="container">
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="mailto:beat.sombrio.ifc@hotmail.com">beat.sombrio.ifc@hotmail.com</a></p>
            </div>
          </div>
        ...
        <div class="form">
          <div id="sendmessage">Sua mensagem foi enviada. Muito Obrigado por sua colaboração!</div>
          <div id="errormessage">Sua mensagem não pôde ser enviada. Tente novamente mais tarde.</div>
          <form action="contactForm.php" method="post" role="form" class="">
            <div class="form-row">
              <div class="form-group col-md-6">
                <input type="text" name="name" class="form-control" id="name" placeholder="Seu Nome" data-rule="minlen:4" data-msg=" Insira no mínimo 4 letras" />
            ...
            <div class="form-group">
              <input type="text" class="form-control" name="subject" id="subject" placeholder="Assunto" data-rule="minlen:4" data-msg="Por favor insira ao menos 8 letras no assunto" />
              <div class="validation"></div>
            </div>
            <div class="form-group">
              <textarea class="form-control" name="message" rows="5" data-rule="required" data-msg="Insira sua mensagem" placeholder="Mensagem"></textarea>
              <div class="validation"></div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="ion-ios-arrow-right"></i> <a href="login.php">Entrar</a></li>
